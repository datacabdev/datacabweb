export const defaultSettings = {
  ...
  dataCasting: {
    ...
    description:
      "The Data Casting Biodiversity initiative uses Raspberry PI based boards, Low-cost environmental sensors and AI enabled DATA analytics simplification tools to reinforce the use of qualitative and quantitative data for evidence based engagements amongst relevant stakeholders such as civil society organizations, newsrooms, communities, academia and relevant government agencies and stakeholders.",
  ...
  appBanner: {
    ...
    subtitle:
      "Don't miss out on real-time updates and streamlined communication – download the app today and stay ahead in the digital world!",
    appStoreUrl: "#",
    playStoreUrl: "#",
  },
};
